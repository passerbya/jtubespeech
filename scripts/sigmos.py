...
class SigMOS:
    ...
    '''
    def __init__(self, model_dir, device_id, model_version=Version.V1):
        ...
        self.session = ort.InferenceSession(model_path_history[model_version], sess_options=options, providers=providers)
...
if __name__ == '__main__':
    ...
    sigmos_estimator = SigMOS(model_dir=script_dir)
