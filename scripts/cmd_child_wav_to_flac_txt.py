...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert Korean cmd_child wav files to mono flac, write same-name txt, and filter non-TTS labels."
    )
    parser.add_argument(
        "root",
        type=Path,
        nargs="?",
        default=Path("/usr/local/corpus/ko/cmd_child"),
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Print progress every N scanned files. Default: 1000",
    )
